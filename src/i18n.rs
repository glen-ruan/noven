...
pub enum Msg {
    ...
    /// Section header for glass and ambient visual effects.
    PrefPanelVisualEffectsSection,
    /// Compositor-backed blur toggle.
    PrefPanelGlassEffect,
    /// Application glass opacity percentage.
    PrefPanelTransparency,
    /// Ambient particle layer toggle.
    PrefPanelParticleEffects,
    /// Ambient particle density row.
    PrefPanelParticleIntensity,
...
const P0_ZH_HANS: [&str; 32] = [
    ...
    "无法读取拖入的图片：{0}",
    "已重新加载外部文件更改",
    "文件已在 Noven 外部更改；请选择重新加载、覆盖或另存副本",
    "文件已在 Noven 外部删除；本地编辑已保留",
    "文件已在 Noven 外部更改",
    ...
    "替换…",
    "图片缺失或无法读取：{0}\n{1}",
    "已拒绝不安全或过期的编辑，文档内容已保留；详情已写入 Noven 日志。",
];
...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemAboutMarkion => "About Noven",
        ...
        Msg::StatusAboutMarkion => "About Noven",
        ...
        Msg::StatusExitingMarkion => "Exiting Noven",
        ...
        Msg::DialogAboutTitle => "About Noven",
        ...
        Msg::DialogAboutStarInvite => {
            "Noven is based on Markion. If it helps you, please give the upstream project a Star."
        }
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "Visual effects",
        Msg::PrefPanelGlassEffect => "Frosted glass",
        Msg::PrefPanelTransparency => "Interface opacity",
        Msg::PrefPanelParticleEffects => "Ambient particles",
        Msg::PrefPanelParticleIntensity => "Particle density",
...
fn ja(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemAboutMarkion => "Novenについて",
        ...
        Msg::StatusAboutMarkion => "Novenについて",
        ...
        Msg::StatusExitingMarkion => "Novenを終了しています",
        ...
        Msg::DialogAboutTitle => "Novenについて",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "視覚効果",
        Msg::PrefPanelGlassEffect => "すりガラス",
        Msg::PrefPanelTransparency => "インターフェースの不透明度",
        Msg::PrefPanelParticleEffects => "アンビエントパーティクル",
        Msg::PrefPanelParticleIntensity => "パーティクル密度",
...
fn fr(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemAboutMarkion => "À propos de Noven",
        ...
        Msg::StatusAboutMarkion => "À propos de Noven",
        ...
        Msg::StatusExitingMarkion => "Fermeture de Noven",
        ...
        Msg::DialogAboutTitle => "À propos de Noven",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "Effets visuels",
        Msg::PrefPanelGlassEffect => "Verre dépoli",
        Msg::PrefPanelTransparency => "Opacité de l’interface",
        Msg::PrefPanelParticleEffects => "Particules ambiantes",
        Msg::PrefPanelParticleIntensity => "Densité des particules",
...
fn de(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemAboutMarkion => "Über Noven",
        ...
        Msg::StatusAboutMarkion => "Über Noven",
        ...
        Msg::StatusExitingMarkion => "Noven wird beendet",
        ...
        Msg::DialogAboutTitle => "Über Noven",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "Visuelle Effekte",
        Msg::PrefPanelGlassEffect => "Milchglas",
        Msg::PrefPanelTransparency => "Oberflächendeckkraft",
        Msg::PrefPanelParticleEffects => "Umgebungspartikel",
        Msg::PrefPanelParticleIntensity => "Partikeldichte",
...
fn es(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemAboutMarkion => "Acerca de Noven",
        ...
        Msg::StatusAboutMarkion => "Acerca de Noven",
        ...
        Msg::StatusExitingMarkion => "Saliendo de Noven",
        ...
        Msg::DialogAboutTitle => "Acerca de Noven",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "Efectos visuales",
        Msg::PrefPanelGlassEffect => "Cristal esmerilado",
        Msg::PrefPanelTransparency => "Opacidad de la interfaz",
        Msg::PrefPanelParticleEffects => "Partículas ambientales",
        Msg::PrefPanelParticleIntensity => "Densidad de partículas",
...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusAboutMarkion => "关于 Noven",
        ...
        Msg::StatusExitingMarkion => "正在退出 Noven",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "视觉效果",
        Msg::PrefPanelGlassEffect => "毛玻璃",
        Msg::PrefPanelTransparency => "界面透明度",
        Msg::PrefPanelParticleEffects => "环境粒子",
        Msg::PrefPanelParticleIntensity => "粒子密度",
...
fn zh_hant(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusAboutMarkion => "關於 Noven",
        ...
        Msg::StatusCanceled => "已取消",
        Msg::StatusExitingMarkion => "正在結束 Noven",
...
{0}"
        ...
        Msg::PrefPanelVisualEffectsSection => "視覺效果",
        Msg::PrefPanelGlassEffect => "毛玻璃",
        Msg::PrefPanelTransparency => "介面透明度",
        Msg::PrefPanelParticleEffects => "環境粒子",
        Msg::PrefPanelParticleIntensity => "粒子密度",
